...
-- Users 더미 데이터
INSERT INTO users (user_id, user_pw, user_name, user_email, user_nic, user_img)
VALUES
...
-- Books 더미 데이터
INSERT INTO books (isbn, title, author, publisher, book_img, publication_date)
VALUES
...
-- Reviews 더미 데이터
INSERT INTO reviews (review_id, user_id, isbn, review_title, review_content)
VALUES
...
-- Book Likes 더미 데이터
INSERT INTO book_like (book_like_id, user_id, isbn)
VALUES
(50, 'ssafy', 'test'),
...
-- Review Likes 더미 데이터
INSERT INTO review_like (review_like_id, user_id, review_id)
VALUES
(1, 'user_1', 1),
(2, 'user_2', 2),
(3, 'user_3', 3),
...
-- Review Comments 더미 데이터
INSERT INTO review_comments (comment_id, user_id, review_id, comment_content)
VALUES
